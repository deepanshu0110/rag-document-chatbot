# Contributing to RAG Document Chatbot
...
2. **Clone** your fork: `git clone https://github.com/<your-username>/rag-document-chatbot.git`
...
Chat with any PDF or TXT using LangChain, FAISS, and OpenAI GPT.
